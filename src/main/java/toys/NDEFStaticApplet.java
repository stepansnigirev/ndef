 ...
 */
public class NDEFStaticApplet extends Applet{
    /** Class code for Teapot applet */
    protected static final byte CLA_NDEF_STATIC          = (byte)0xB0;
    ...
    /** 
     * Create an instance of the NDEFStaticApplet using its constructor, 
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength){
        ...
        if(bArray!=null && bArray.length > 0){
            ...
            new NDEFStaticApplet().register(bArray, (short) (bOffset + 1), bArray[bOffset]);
        }else{
            // keep the simulator happy and register without arguments
            new NDEFStaticApplet().register();
        }
    }
     ...
     * @param apdu - APDU command to process. CLA should be 0xB0 (CLA_NDEF_STATIC),
    ...
    public void process(APDU apdu){
        ...
        // If the CLA is not equal to 0xB0(CLA_NDEF_STATIC),  throw an exception.
        if(buf[ISO7816.OFFSET_CLA] != CLA_NDEF_STATIC){
